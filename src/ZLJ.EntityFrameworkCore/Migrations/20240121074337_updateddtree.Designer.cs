...
namespace ZLJ.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20240121074337_updateddtree")]
    partial class updateddtree
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BXJG.Utils.GeneralTree.DataDictionaryEntity", b =>
                {
                    ...
                    b.ToTable("bxjg_utils_data_dictionary");
                });
            ...
            modelBuilder.Entity("ZLJ.Core.BaseInfo.Administrative.AdministrativeEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ZLJ.Core.BaseInfo.Administrative.AdministrativeEntity", b =>
                {
                    b.HasOne("ZLJ.Core.BaseInfo.Administrative.AdministrativeEntity", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");
            ...
            modelBuilder.Entity("ZLJ.Core.BaseInfo.AssociatedCompany.AssociatedCompanyEntity", b =>
                {
                    ...
                    b.HasOne("ZLJ.Core.BaseInfo.Administrative.AdministrativeEntity", "Area")
                        .WithMany()
