...
namespace ZLJ.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20251202182557_addjxc")]
    partial class addjxc
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BXJG.PSI.MasterData.AssociatedCompany.BXJGAssociatedCompanyEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("KehuXinxi", null, t =>
                        {
                            t.HasComment("往来单位实体");
                        });

                    b.HasDiscriminator().HasValue("BXJGAssociatedCompanyEntity");

                    b.UseTphMappingStrategy();
                });

            modelBuilder.Entity("BXJG.PSI.MasterData.Product.ProductCategoryEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("psi_ProductCategory", null, t =>
                        {
                            t.HasComment("产品分类实体");
                        });
                });

            modelBuilder.Entity("BXJG.PSI.MasterData.Product.ProductEntity", b =>
                {
                    ...
                    b.ToTable("ShebeiXinxi", null, t =>
                        {
                            t.HasComment("商品档案实体");
                        });
                });

            modelBuilder.Entity("BXJG.PSI.MasterData.Warehouse.WarehouseEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("唯一id，主键");
                    ...
                    b.ToTable("psi_Warehouse", null, t =>
                        {
                            t.HasComment("仓库档案实体");
                        });
                });
            ...
            modelBuilder.Entity("ZLJ.Core.AssociatedCompany.AssociatedCompanyEntity", b =>
                {
                    b.HasBaseType("BXJG.PSI.MasterData.AssociatedCompany.BXJGAssociatedCompanyEntity");
                    ...
                    b.HasDiscriminator().HasValue("AssociatedCompanyEntity");
                });
            ...
            modelBuilder.Entity("BXJG.PSI.MasterData.Product.ProductCategoryEntity", b =>
                {
                    b.HasOne("BXJG.PSI.MasterData.Product.ProductCategoryEntity", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");
            ...
            modelBuilder.Entity("BXJG.PSI.MasterData.Product.ProductEntity", b =>
                {
                    b.HasOne("BXJG.PSI.MasterData.Product.ProductCategoryEntity", "Category")
                        .WithMany("Products")
