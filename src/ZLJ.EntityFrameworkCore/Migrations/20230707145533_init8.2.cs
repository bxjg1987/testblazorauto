    ...
    public partial class init82 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_baseinfo_administrative", x => x.Id);
                    table.ForeignKey(
                        name: "FK_baseinfo_administrative_baseinfo_administrative_ParentId",
                        column: x => x.ParentId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    No = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    AreaId = table.Column<long>(type: "bigint", nullable: true),
                    CurrentAddress = table.Column<string>(type: "nvarchar(300)", nullable: true),
                    InDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    ...
                    CustomerId = table.Column<long>(type: "bigint", nullable: true),
                    EquipmentPwd = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AssociatedCompanyEntityId = table.Column<long>(type: "bigint", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AbpUsers_baseinfo_administrative_AreaId",
                        column: x => x.AreaId,
                        principalTable: "baseinfo_administrative",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Lng = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    Lat = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    AreaId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbpOrganizationUnits_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_baseinfo_administrative_ParentId",
