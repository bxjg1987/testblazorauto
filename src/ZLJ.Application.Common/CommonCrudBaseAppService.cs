...
namespace ZLJ.Application.Common
{
    ...
    public abstract class CommonCrudBaseAppService<TEntity,
                                          TEntityDto,
                                          TPrimaryKey,
                                          TGetAllInput,
                                          TCreateInput,
        ...
        where TDeleteInput : IEntityDto<TPrimaryKey>
    {
        ...
        protected virtual ILocalizationSource LocalizationSourceAppZLJ
        {
            get
            {
                ...
                {
                    zljLocalizationSource = ZLJ.Core.Localization.LocalizationExtensions.GetZLJCoreLocalizationSource();// LocalizationManager.GetSource(ZLJ.Core.Share.ZLJConsts.LocalizationSourceName);
                }
