...
{
    public partial class CustomerAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            #region 后端
            var admin = context.CreatePermission(PermissionNames.Customer, PermissionNames.Customer.GetCustomerLocalizableString());
        ...
        {
            return new LocalizableString(name, CustomerConsts.Customer);
        }
    }
}