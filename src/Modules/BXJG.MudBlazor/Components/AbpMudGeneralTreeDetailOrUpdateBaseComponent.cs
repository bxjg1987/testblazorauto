...
{
    /// <summary>
    /// 基于abp mudblazor的 通用树详情、修改抽象组件
    /// </summary>
    /// <typeparam name="TAppService">应用服务类型</typeparam>
    /// <typeparam name="TEntityDto">显示模型类型</typeparam>
    /// <typeparam name="TUpdateInput">修改时输入参数类型</typeparam>
    /// <typeparam name="TCreateInput">新增时输入参数类型</typeparam>
    /// <typeparam name="TGetAllInput">获取分页列表时的输入参数类型</typeparam>
        ...
        where TAppService : IGeneralTreeBaseAppService<TEntityDto, TCreateInput, TUpdateInput, TGetAllInput>
    {
        ...
        protected virtual async Task BtnOkDeleteClick()
        {
            ...
            try
            {
                var r = await AppService.DeleteAsync(new BatchOperationInputLong { Ids = new[] { Id } });
                if (r.Ids.Any())
                {
    ...
    /// <typeparam name="TCreateInput">新增时输入参数类型</typeparam>
    /// <typeparam name="TGetAllInput">获取分页列表时的输入参数类型</typeparam>
    public abstract class AbpMudGeneralTreeDetailOrUpdateDialogBaseComponent<TAppService,
                                                                             TEntityDto,
                                                                             TUpdateInput,
                                                                             TCreateInput,
                                                                             TGetAllInput> : AbpMudGeneralTreeDetailOrUpdateBaseComponent<TAppService,
                                                                                                                                          TEntityDto,
                                                                                                                                          TUpdateInput,
                                                                                                                                          TCreateInput,
                                                                                                                                          TGetAllInput>
