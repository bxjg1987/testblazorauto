...
namespace BXJG.DynamicAssociateEntity
{
    public static class DynamicAssociateEntityExt
    {
        ...
        /// <returns></returns>
        public static IList<IDictionary<string, object>> MapToEntity(this IDictionary<string, object> dto, IReadOnlyList<DefineMapItem> defines)
        {
            #region 数据格式
            /*
             * dto
            ...
            var targets = new List<IDictionary<string, object>>();//准备要返回的数据格式
        ...
        /// <param name="dto"></param>
        /// <returns></returns>
        public static string DtoMapToEntityJsonString(this IDictionary<string, object> dto, IReadOnlyList<DefineMapItem> defines)
        {
        ...
        /// <param name="defines">dynamicAssociateEntityDefineManager.GroupedDefines[name].LeafItems</param>
        /// <param name="dto"></param>
        public static void CheckMap(this IDictionary<string, object> dto, IReadOnlyList<DefineMapItem> defines)
        {
            #region 数据格式
            /*
             * dto
        ...
        /// <returns></returns>
        public static IList<IDictionary<string, object>> ToDynamicAssociateData(this string str)
        {
            return JsonSerializer.Deserialize<IList<IDictionary<string, object>>>(str);
        }
        /// <summary>
        /// 转换为动态关联的值
        /// </summary>
        ...
        /// <returns></returns>
        public static IList<IDictionary<string, object>> ToDynamicAssociateData(this IDynamicAssociateEntity entity)
        {
