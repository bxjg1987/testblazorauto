...
namespace BXJG.Utils.BCL
{
    /*
     * 由于微软的AuthorizationView没有提供扩展能力，所以这里是将AuthorizationView组件的代码复制过来进行魔改的
     */

    /// <summary>
    /// 基于功能的授权组件
    /// </summary>
    public class AbpAuthorizationView : ComponentBase
    {
        ...
        /// <summary>
        /// PermissionNames不为空时有效，true所以权限全部验证通过才认为权限验证成功，否则任意权限验证通过都表示通过
        /// </summary>
