...
namespace ZLJ.App.Admin.WorkOrder.RentOrderItem
{
    ...
    /// 后台管理-客户设备工单-操作日志
    /// </summary>
    public class RentOrderItemWorkOrderOperationLogAppService : OperationLogAppService<User>
    {
        ...
        public RentOrderItemWorkOrderOperationLogAppService(IRepository<EntityChange, long> repository,
