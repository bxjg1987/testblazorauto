...
namespace ZLJ.Application.OU
{
    ...
    public partial class AutoMapperProfile : Profile
    {
        ...
        public AutoMapperProfile()
        {
            ...
            CreateMap<ZLJ.Application.Share.OU.OUCreateDto, OrganizationUnitEntity>().IncludeBaseOuCreate();
            CreateMap<ZLJ.Application.Share.OU.OUEditDto, OrganizationUnitEntity>().IncludeBaseOuEdit();
            this.CreateMapOu<OUDto>(); CreateMap<OrganizationUnit, OUDto>().IncludeBaseOuDto();
            #endregion
        }
    }
