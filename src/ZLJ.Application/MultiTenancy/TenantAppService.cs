...
namespace ZLJ.Application.MultiTenancy
{
    ...
    public class TenantAppService : AdminCrudBaseAppService<Tenant,
                                                            TenantDto,
                                                            int,
        ...
        ITenantAppService
    {
        ...
        public override async Task<TenantDto> CreateAsync(EditTenantDto input)
        {
            ...
            var tenanttId = await TenantManager.CreateWithAdminUserAsync(input.TenancyName, input.Name, User.DefaultPassword, input.ConnectionString);
            ...
            //}
            var tenant = await TenantManager.GetByIdAsync(tenanttId);
