...
public partial class List
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        await base.InitPermission(PermissionNames.BXJGBaseInfoAdministrativeCreate, PermissionNames.BXJGBaseInfoAdministrativeUpdate, PermissionNames.BXJGBaseInfoAdministrativeDelete);
    ...
    Dictionary<string, object> OnRow(RowData<AdministrativeDto> row)
    {
   ...
   void CloseCreateDialogCore()
    ...
    /// <param name="sr"></param>
    /// <returns></returns>
  void OnAddEnd(SaveResult<AdministrativeDto> sr)
    {
    ...
    /// <param name="sr"></param>
    /// <returns></returns>
  void OnDetailUpdate(AdministrativeDto sr)
    {
    ...
    void OnEdit(AdministrativeDto sr)
    {
        isEdit = true;
    ...
    void OnDetail(AdministrativeDto sr)
    {
        isEdit = false;
        detailUpdateId = sr.Id;
        isShowDetailUpdate = true;
