...
namespace ZLJ.Admin.CoreRCL.Staffinfo
{
    ...
    {
        protected override string FuncName => "员工管理";
        /// <summary>
        /// 组件初始化
        /// </summary>
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            await base.InitPermission(PermissionNames.BXJGBaseInfoStaffInfoCreate,
                                      PermissionNames.BXJGBaseInfoStaffInfoUpdate,
        ...
        /// 表格中每行的额外属性
        /// </summary>
        Dictionary<string, object> OnRow(RowData<StaffInfoDto> row)
        {
        ...
        /// <param name="sr"></param>
        /// <returns></returns>
        void OnAddEnd(BXJG.Utils.RCL.Components.SaveResult<StaffInfoDto> sr)
        {
            isNeedReload = true;
            if (sr.End)
            {
        ...
        /// <param name="sr"></param>
        /// <returns></returns>
        void DetailUpdated(StaffInfoDto sr)
        {
        ...
        void DetailDeleted(StaffInfoDto dto)
        {
            isNeedReload = true;
            isShowDetailUpdate = false;
        }
        ...
        /// </summary>
        /// <param name="sr"></param>
        void BtnItemEditClick(StaffInfoDto sr)
        {
            isEdit = true;
        ...
        /// </summary>
        /// <param name="sr"></param>
        void BtnItemDetailClick(StaffInfoDto sr)
        {
            isEdit = false;
            ShowUpdateOrDetail(sr.Id);
        }
