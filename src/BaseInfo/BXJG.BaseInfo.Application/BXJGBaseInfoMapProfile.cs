...
{
    public class BXJGBaseInfoMapProfile<TUser, TArea, TDataDictionary> : Profile
    {
        public BXJGBaseInfoMapProfile()
        {
            #region 行政区
            CreateMap<BaseInfoInfoEntity<TDataDictionary>, BaseInfoInfoDto>();
            CreateMap<BaseInfoInfoDto, BaseInfoInfoEntity<TDataDictionary>>();

            CreateMap<BaseInfoInfoEntity, BaseInfoInfoDto>();
            CreateMap<BaseInfoInfoDto, BaseInfoInfoEntity>();

            CreateMap<BaseInfoInfoEditDto, BaseInfoInfoEntity<TDataDictionary>>();
            CreateMap<BaseInfoInfoEditDto, BaseInfoInfoEntity>();
            #endregion
            //#region 商品分类
