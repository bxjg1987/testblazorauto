...
namespace BXJG.Shop
{
    public class BXJGShopMapProfile : Profile
    {
        ...
        {
            #region 商品分类
            CreateMap<ItemCategoryEditDto, ProductCategoryEntity>();
            CreateMap<ProductCategoryEntity, ItemCategoryDto>();
            CreateMap<ProductCategoryEntity, ItemCategoryTreeNodeDto>().EntityToComboTree();
            CreateMap<ProductCategoryEntity, ItemCategoryCombboxDto>().EntityToCombobox();
