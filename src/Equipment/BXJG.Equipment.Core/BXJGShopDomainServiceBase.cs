...
namespace BXJG.Equipment
{
    ...
    /// 领域服务基类
    /// </summary>
    public class BXJGEquipmentDomainServiceBase : DomainService
    {
        ...
        public BXJGEquipmentDomainServiceBase()
        {
            base.LocalizationSourceName = BXJGEquipmentConst.LocalizationSourceName;
