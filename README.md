...
**此项目 = [abp9.x(一代)](https://aspnetboilerplate.com/) + 通用abp模块 + 帮助库 + blazor web app （auto模式）** 
...
**blazor** 
[abp9.x(一代)](https://aspnetboilerplate.com/)默认是不支持blazor的，但本项目对blazor web app （auto模式）做了集成，且默认使用[AntBlazor](https://ant-design-blazor.gitee.io/zh-CN/components/overview)，你可以修改代码替换成其它ui框架。
