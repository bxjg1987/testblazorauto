...
**此项目 = [abp9.x(一代)](https://aspnetboilerplate.com/) + 通用abp模块 + 帮助库 + blazor web app auto模式渐进式分离** 
...
**blazor** 
[abp9.x(一代)](https://aspnetboilerplate.com/)默认是不支持blazor的，但本项目对blazor web app auto模式渐进式分离做了集成，且默认使用[Ant Design Blazor](https://antblazor.com/zh-CN/)，你可以修改代码替换成其它ui框架。

# 特征
1. [abp9.x(一代)](https://aspnetboilerplate.com/)的所有特征
1. blazor web app auto模式渐进式分离集成
...
# 快速开始
## 环境
vs2022 .net8 mssql/mysql5.7+(推荐8)
## 启动项目
1. 克隆项目
