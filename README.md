<h1>迁移说明</h1>
 **当前项目中的模块是可以用的，通用树、附件管理、工单模块、微信小程序登陆、blazor日志、blazor echart 等等..<br />
但项目整体编译会报错，因为它目前只是用来存放通用模块，另外对应的前端项目也没有在更新。<br />** 

<h1>基本介绍</h1>
在线演示地址：http://web1.cqyuzuji.com:9000 账号密码：admin 123qwe<br />
这是一个基于.net8 abp8.x的系统，非vNext版本，目的是累积日常开发中需要的模块 实现快速变现的目的。模块尽量按abp的方式实现。目前已经有几个模块了(下面会说明)，后续会慢慢累积<br />
使用blazor server模式
